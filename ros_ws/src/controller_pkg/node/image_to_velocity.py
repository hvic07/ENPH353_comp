...
pub_cmd = rospy.Publisher('/B1/cmd_vel', Twist, queue_size=10)
pub_score = rospy.Publisher('/score_tracker', String, queue_size=1)

move_star = Twist()
move_star.linear.x = 0.5
move_star.angular.z = 0

move_stop = Twist()
move_stop.linear.x = 0.0

rospy.sleep(1)
pub_score.publish('gadget, unknown, 0, AAAAA')
rospy.sleep(2)
pub_cmd.publish(move_star)
rospy.sleep(5)
pub_cmd.publish(move_stop)
pub_score.publish('gadget, unknown, -1, AAA')
...
#         self.score_pub.publish('gadget,unknown,0,AAAA')
#         rospy.sleep(5)
#         self.score_pub.publish('gadget, unknown, -1, AAA')
